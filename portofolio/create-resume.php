...
if (isset($_POST['save'])) {
    ...
    if ($id) {
        ...
        (title, year_start, year_end, institution, description, desc_detail) VALUES 
        ('$title', '$year_start', '$year_end', '$institution', '$description', '$desc_detail')");
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="desc_detail" id="" class="form-control"><?php echo ($id) ? $row['desc_detail'] : ''?></textarea>
                                    </div>
